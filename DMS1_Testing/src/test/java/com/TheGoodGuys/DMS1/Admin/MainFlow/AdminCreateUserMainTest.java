...
import resources.page.AdminPages.GroupPages.AdminAssignUsersToGroupPage;
...
public class AdminCreateUserMainTest extends AbstractTest {
	...
	@BeforeGroups(groups = { "changePassword" })
	@Parameters({"apiURL"})
	public void createTestUser(String apiURL) throws UnirestException {
		
		ManageAutotestingData.createUser(apiURL, "testUser001", "test", "test", "Password1", "autotesting");
	
	}
	
//	@DataProvider(name = "validPasswords")
//	public static Object[] testDataValidPassword() throws IOException {
//		return FileReaderUtils.getUsersFromXml("src/test/java/resources/testData/MainFlowAdminCreateElements/ChangePasswordValid.xml");
//	}
	
//	@Test (priority = 10, groups = { "changePassword" })
//	public void testToChangePassword(User user) {
//		adminNav.clickButtonUsers();
