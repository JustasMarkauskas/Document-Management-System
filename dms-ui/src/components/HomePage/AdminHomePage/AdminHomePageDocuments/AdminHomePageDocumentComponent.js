...
const AdminHomePageDocumentComponet = ({handleSearchField, handleSearchButton}) => {
    return (
                ...
                <div className="row col-lg-9 shadow-sm p-3 mb-5 bg-light rounded">
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                            <th scope="row">1</th>
                            <td>Prasymas isleisti kasmetiniu atostogu</td>                           
                            </tr>
                            <tr>
                            <th scope="row">2</th>
                            <td>Komandiruotpinigiu prasymas</td>
                            </tr>
                            <tr>
                            <th scope="row">3</th>
                            <td>Prasymas atleisti is darbo</td>
                            </tr>                            
                        </tbody>
                        </table>
                    </div>
...
export default AdminHomePageDocumentComponet;